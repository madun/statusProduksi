...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                <form method="post" action="pages/qc/prosesInput.php">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="form-group">
                            <label class="form-label">Dotsu</label>
                            <input type="text" name="dotsu" class="form-control" placeholder="Kabel" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Gaikan 1</label>
                            <input type="text" name="gaikan1" class="form-control" placeholder="Fulltape" required>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Gaikan 2</label>
                            <input type="text" name="gaikan2" class="form-control" placeholder="Korget">
                        </div>
                    </div> <!-- card body -->
